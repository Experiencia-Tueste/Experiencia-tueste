  ...
  return (
    <section id="mercado" className={styles.section} aria-labelledby="mercado-titulo">
      ...
      <p className={styles.lead}>
        ...
        producto y vender directo. Tueste es el puente — la venta será tuya. Todo lo que ves aquí es
        una vista demostrativa: la operación se habilitará cuando el cliente confirme el flujo.
      </p>
      ...
      <div className={styles.reg}>
        ...
        <form className={styles.form} onSubmit={publicar}>
          <label className={styles.field}>
            Marca o finca *
            <input type="text" name="marca" required maxLength={40} placeholder="Finca El Roble" />
          </label>
          <label className={styles.field}>
            Tipo de producto *
