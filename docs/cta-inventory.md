...
| `market-publicar`           | Solicitar publicación             | `/experiencia` (MercadoOrigen)               | commercial-intent | Solicitud autenticada para revisión antes de publicar                     | Correcto           |
| `community-join`            | Unirme con mi cuenta              | `/experiencia` (Comunidad)                   | commercial-intent | Solicitud autenticada con correo verificado de la cuenta                  | Correcto           |
