  ...
  return (
    <>
      <div id="negocios" className={styles.b2b} aria-labelledby="b2b-titulo">
        ...
        <p>
          Dos servicios por suscripción para cafés, hoteles, tiendas y marcas de café: la radio que
          hace sonar tu negocio y el mercado donde vendes tu café directo.
        </p>
      </div>
      ...
      <section id="radio" className={styles.section} aria-labelledby="radio-titulo">
        ...
        <div className={styles.demo}>
          <div>
            ...
            <p>
              Las señales suenan en el reproductor de la página — la de la casa y las diseñadas por
              tipo de negocio, encadenando piezas en continuo. Elige una y déjala sonar.
            </p>
          </div>
